        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="/sav_brand" method="post" id="my_add_brand">
                            <div class="space-14"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4"> 商品名字 </label>
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-4" class="col-xs-10 col-sm-5" name="name"/>
                                </div>
                            </div>
                            <div class="form-group" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" class="col-xs-10 col-sm-5" name="imgUrl"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-6"> 网站 </label>
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-6" class="col-xs-10 col-sm-5" name="webSite"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-5"> 排序 </label>
                                <div class="col-sm-9">
                                    <input type="text" onkeyup="value=value.replace(/[^\d]/g,'') " ng-pattern="/[^a-zA-Z]/" id="form-field-5" class="col-xs-10 col-sm-5" name="sort"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> 是否上架 </label>
                                <div class="col-sm-9" id="form-field-3" style="margin-top: 5px">
                                    <input type="radio" value="是"  name="isDisplay" checked>是
                                    <input type="radio" value="否" name="isDisplay" >否
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button class="btn btn-info" type="button" id="sva_brand_btn">
...
<script type="text/javascript">
    if ('ontouchstart' in document.documentElement) document.write("<script " +
        "src='/ace/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
</script>
