        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="/savSku" method="post" id="myform">
                                    ...
                                    <c:forEach items="${ce}" var="ce">
                                        <div class="checkbox"  style="float: left">
                                            <label>
                                                ...
                                                <c:if test="${sku.color.equals(ce.massage)}">checked</c:if>/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="control-group" id="form-field-2">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" class="ace" name="sex" value="female" <c:if test="${user.sex=='female'}">checked</c:if>/>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" class="ace" name="sex" value="male" <c:if test="${user.sex=='male'}">checked</c:if>/>
