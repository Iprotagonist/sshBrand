                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-group">
                                        <label for="name" class="col-sm-1 control-label text-right">商品名：</label>
                                        <div class="col-sm-3">
                        ...
                        <div id="toolbar" class="btn-group">
                            ...
                            <button id="update" class="btn btn-success btn-sm" >
                                <i class="fa fa-pencil-square-o"></i> 修改
                            </button>
                            <button type="button" class="btn btn-primary btn-sm" id="skubtn">
...
<script type="text/javascript">
    ...
    $remove.click(function () {
        layer.confirm("确定删除吗?", function () {
            ...
            // window.location.href = "/deluser?ids=" + selections;
            var json = {
                ids: selections.join()
            }
            $.get('/delete_product', json, function (data) {
                if (data.success) {
                    //刷新table,会重新取数据库中删除后的数据
                    $table.bootstrapTable('refresh');
     ...
     */
    $add.click(function () {
        window.location.href="to_add_product";
    });
    /**
     * 修改元素
     */
    $update.click(function () {
        if(selections.length == 1){
            window.location.href="/user/" + selections;
        }else {
    ...
    $skubtn.click(function () {
                if(selections.length == 1){
                    window.location.href="/toSkuProductId/" + selections;
                }else {
                    layer.msg('请选择一条数据',{icon:3});
                }
            })
